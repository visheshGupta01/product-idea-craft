        ...
        <div className="bg-white w-full   rounded-[35px] p-6 flex flex-col border border-black items-center justify-between relative">
          ...
          <div className="relative w-full max-h-52 mb-4 font-poppins  text-gray-800">
            <textarea
              ...
              className="custom-scroll w-full px-4 py-3 max-h-52 pr-24 overflow-y-scroll rounded-md bg-white text-sm focus:outline-none font-poppins resize-none break-words overflow-wrap-anywhere"
              style={{
                border: "none",
                boxShadow: "none",
                outline: "none",
