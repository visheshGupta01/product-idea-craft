...
const ChatPanel = ({
  ...
  return (
    <div className="h-full flex flex-col bg-card">{/* Changed from h-screen to h-full to work with navbar */}
      {/* Header */}
      ...
      <div className="p-4 border-t border-border bg-card">
        <div className="flex space-x-2">
          <Input
            ...
            className="flex-1 bg-accent border-border text-foreground placeholder:text-muted-foreground rounded-2xl"
            disabled={isLoading}
          />
          <Button
            onClick={sendMessage}
